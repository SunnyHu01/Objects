...
CREATE TABLESPACE ts_seckey_admin 
    LOGGING  
    DATAFILE '/oracle/base/oradata/snorcl11g/ts_seckey_admin.dbf' SIZE 50M 
    EXTENT MANAGEMENT LOCAL;


CREATE TABLESPACE ts_seckey_op
    LOGGING 
    DATAFILE '/oracle/base/oradata/snorcl11g/ts_seckey_op.dbf' SIZE 200M
    EXTENT MANAGEMENT LOCAL;
    
ALTER DATABASE DATAFILE '/oracle/base/oradata/snorcl11g/ts_seckey_admin.dbf' AUTOEXTEND ON NEXT   50M MAXSIZE UNLIMITED;
ALTER DATABASE DATAFILE '/oracle/base/oradata/snorcl11g/ts_seckey_op.dbf' AUTOEXTEND ON NEXT  200M MAXSIZE UNLIMITED; 
